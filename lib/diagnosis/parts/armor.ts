    ...
    if (slot === "상의" || slot === "하의") {
        if (itemName.includes("에테르넬")) {
            if (starforce >= 25) {
                ...
                comments.push(`[고급 세팅] <b>${starforce}성</b> 에테르넬은 준수한 성능입니다. 21성 이상을 목표로 하세요.`);
            ...
            if (starforce >= 25) {
                ...
                comments.push(`[고급 세팅] <b>${starforce}성</b> 카루타는 준수한 성능입니다. 22성을 목표로 하세요.`);
            } else if (starforce === 17) {
        ...
        if (itemName.includes('펜살리르')) {
            ...
            if (starforce >= 23) {
                ...
                if (starforce >= 25) {
                    ...
                    comments.push(`[고급 세팅] <b>${starforce}성</b> 에테르넬은 준수한 성능입니다. 22성을 목표로 하세요.`);
                } else if (starforce === 17) {
