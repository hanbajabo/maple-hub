...
const BossDiagnosis: React.FC<BossDiagnosisProps> = ({ equipment, stat, basic }) => {
    ...
    const { stage, issues, attTypeKor, setCounts, passedArmorOption, isGenesisWeapon, stage4Stats, stage5Stats, stage6Info, stage7Stats } = useMemo(() =>
    ...
    const stages = [
        ...
        { id: 7, title: "⚔️ [8단계] 22성급 방어구 셋팅", description: "22성급 방어구 세트 방향을 정했다면 진짜 22성급 템을 맞춰보자!", color: "pink" }
    ];
