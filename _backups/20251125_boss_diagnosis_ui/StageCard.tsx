...
export const StageCard: React.FC<StageCardProps> = ({
    stageInfo, isCurrent, isPassed, isExpanded, onToggle, attTypeKor, setCounts, passedArmorOption, isGenesisWeapon, stage4Stats, stage5Stats, stage6Info, stage7Stats
}) => {
    // 세트 효과 만족 여부 헬퍼
                        ...
                        <div className="space-y-4 text-sm">
                            <div className="bg-gradient-to-r from-purple-950/30 to-pink-950/30 p-4 rounded-lg border border-purple-900/50">
                                ...
                                <div className="bg-slate-950/50 p-3 rounded-lg border border-slate-800">
                                    ...
                                    <ul className="space-y-1 text-slate-300 pl-1">
                                        <li className={`flex items-center gap-2 ${stage7Stats.cra22Count >= 3 ? 'text-green-300 font-bold' : ''}`}>
                                            <span>{stage7Stats.cra22Count >= 3 ? '✅' : '•'}</span>
                                            <span>22성上 루타비스 3세트 <span className="text-slate-500">(현재: {stage7Stats.cra22Count}개)</span></span>
                                        </li>
                                        <li className={`flex items-center gap-2 ${stage7Stats.absol22Count >= 4 ? 'text-green-300 font-bold' : ''}`}>
                                            <span>{stage7Stats.absol22Count >= 4 ? '✅' : '•'}</span>
                                            <span>22성上 앱솔랩스 4세트 <span className="text-slate-500">(현재: {stage7Stats.absol22Count}개)</span></span>
                                        </li>
                                        <li className={`flex items-center gap-2 ${stage7Stats.arcane22Count >= 4 ? 'text-green-300 font-bold' : ''}`}>
                                            <span>{stage7Stats.arcane22Count >= 4 ? '✅' : '•'}</span>
                                            <span>22성上 아케인 4세트 <span className="text-slate-500">(현재: {stage7Stats.arcane22Count}개)</span></span>
                                        </li>
                                        <li className={`flex items-center gap-2 ${stage7Stats.eternal17Count >= 3 ? 'text-green-300 font-bold' : ''}`}>
                                            <span>{stage7Stats.eternal17Count >= 3 ? '✅' : '•'}</span>
                                            <span>17성上 에테르넬 3세트 <span className="text-slate-500">(현재: {stage7Stats.eternal17Count}개)</span></span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="mt-3 bg-slate-950/50 p-3 rounded-lg border border-slate-800">
                                    ...
                                    <ul className="space-y-1 text-slate-300 pl-1">
                                        <li className={`flex items-center gap-2 ${stage7Stats.isEternal4SetSatisfied ? 'text-green-300 font-bold' : ''}`}>
                                            <span>{stage7Stats.isEternal4SetSatisfied ? '✅' : '•'}</span>
                                            <span>17성上 에테르넬 4세트 이상 <span className="text-slate-500">(현재: {stage7Stats.eternal17Count}개)</span></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
