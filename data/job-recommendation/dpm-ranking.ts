...
export const DPM_RANKING_DATA: DPMRanking[] = [
    ...
    { rank: 4, tier: '🔴', job: '배틀메이지' },
    { rank: 5, tier: '🔴', job: '섀도어' },
    { rank: 6, tier: '🔴', job: '일리움' },
    { rank: 7, tier: '🔴', job: '은월' },
    { rank: 8, tier: '🔴', job: '렌' },
    { rank: 9, tier: '🔴', job: '아크' },
    { rank: 10, tier: '🔴', job: '아크메이지(썬,콜)' },
    { rank: 11, tier: '🔴', job: '윈드브레이커' },
    { rank: 12, tier: '🔴', job: '칼리' },
    { rank: 13, tier: '🔴', job: '블래스터' },
    { rank: 14, tier: '🔴', job: '플레임위자드' },

    // 상위 티어 - 극딜 추천 (15-28위)
    { rank: 15, tier: '🟠', job: '제로' },
    { rank: 16, tier: '🟠', job: '카인' },
    { rank: 17, tier: '🟠', job: '아델' },
    { rank: 18, tier: '🟠', job: '스트라이커' },
    { rank: 19, tier: '🟠', job: '아크메이지(불,독)' },
    { rank: 20, tier: '🟠', job: '제논' },
    ...
    // 중위 티어 - 선택형 (29-38위)
    { rank: 29, tier: '⚪', job: '비숍' },
    { rank: 30, tier: '⚪', job: '소울마스터' },
    { rank: 31, tier: '⚪', job: '아란' },
    { rank: 32, tier: '⚪', job: '다크나이트' },
    { rank: 33, tier: '⚪', job: '와일드헌터' },
    { rank: 34, tier: '⚪', job: '팔라딘' },
    { rank: 35, tier: '⚪', job: '보우마스터' },
    { rank: 36, tier: '⚪', job: '신궁' },
    { rank: 37, tier: '⚪', job: '에반' },
    { rank: 38, tier: '⚪', job: '패스파인더' },

    // 하위 티어 - 비추천 (39-47위)
    { rank: 39, tier: '🔵', job: '캐논슈터' },
    { rank: 40, tier: '🔵', job: '캡틴' },
    { rank: 41, tier: '🔵', job: '바이퍼' },
    { rank: 42, tier: '🔵', job: '카이저' },
    { rank: 43, tier: '🔵', job: '데몬슬레이어' },
    { rank: 44, tier: '🔵', job: '데몬어벤져' },
    { rank: 45, tier: '🔵', job: '나이트워커' },
    { rank: 46, tier: '🔵', job: '키네시스' },
    { rank: 47, tier: '🔵', job: '미하일' }
];
