                    ...
                    >
                        {item ? (
                            <>
                                ...
                                {/* Tooltip */}
                                <div className="absolute left-1/2 bottom-full mb-2 -translate-x-1/2 w-64 sm:w-80 bg-slate-950 border border-slate-700 rounded-lg p-3 sm:p-5 shadow-2xl z-50 hidden group-hover:block pointer-events-none leading-relaxed">
