...
export default function CalculatorMenu() {
    return (
        <div className="relative group">
            ...
            {/* Dropdown Menu */}
            <div className="absolute right-0 top-full mt-2 w-72 bg-slate-900 border-2 border-indigo-500/50 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[9999]">
                <div className="py-2">
                    <Link
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] text-slate-400 mt-0.5 whitespace-nowrap">[체인지 버닝 : 루시드] 보스 최소컷 계산기</span>
                        </div>
                    </Link>
