...
// 모험가 직업은 1~3차 전직 직업명도 포함 (보유 여부 확인용)
export const UNION_STAT_JOBS: Record<string, string[]> = {
    "STR": [
        ...
        "캐논슈터", "캐논블래스터", "캐논마스터",
        // 기타 STR 직업
        "소울마스터", "미하일", "블래스터", "데몬슬레이어", "아란", "카이저", "아델", "제로", "렌", "스트라이커", "은월", "제논", "레테"
    ],
    "DEX": [
        // 보우마스터 계열
        "헌터", "레인저", "보우마스터",
        ...
        "건슬링거", "발키리", "캡틴",
        // 기타 DEX 직업
        "윈드브레이커", "와일드헌터", "메르세데스", "카인", "엔젤릭버스터", "메카닉", "제논", "레테"
    ],
    "INT": [
        // 아크메이지(불,독) 계열
        "메이지(불,독)", "위자드(불,독)", "아크메이지(불,독)",
        // 아크메이지(썬,콜) 계열
        "메이지(썬,콜)", "위자드(썬,콜)", "아크메이지(썬,콜)",
        // 비숍 계열
        "클레릭", "프리스트", "비숍",
        // 기타 INT 직업
        "플레임위자드", "배틀메이지", "에반", "루미너스", "키네시스", "일리움", "라라", "레테"
    ],
    "LUK": [
        // 나이트로드 계열
        "어쌔신", "허밋", "나이트로드",
        ...
        "시프", "시프마스터", "섀도어",
        // 듀얼블레이더 계열
        "듀어러", "듀얼마스터", "슬래셔", "세미듀어러", "듀얼블레이드", "듀얼블레이더",
        // 기타 LUK 직업
        "나이트워커", "팬텀", "카데나", "칼리", "호영", "제논", "레테"
    ],
    "HP": ["데몬어벤져"]
};

// 추천용 최종 직업명만 포함 (1~2차 전직 제외, 육성 추천 메시지에 사용)
export const UNION_STAT_RECOMMEND_JOBS: Record<string, string[]> = {
    "STR": ["히어로", "팔라딘", "다크나이트", "바이퍼", "캐논마스터", "소울마스터", "미하일", "블래스터", "데몬슬레이어", "아란", "카이저", "아델", "아크", "제로", "렌", "스트라이커", "은월", "제논", "레테"],
    "DEX": ["보우마스터", "신궁", "패스파인더", "캡틴", "윈드브레이커", "와일드헌터", "메르세데스", "카인", "엔젤릭버스터", "메카닉", "제논", "레테"],
    "INT": ["아크메이지(불,독)", "아크메이지(썬,콜)", "비숍", "플레임위자드", "배틀메이지", "에반", "루미너스", "키네시스", "일리움", "라라", "레테"],
    "LUK": ["나이트로드", "섀도어", "듀얼블레이더", "나이트워커", "팬텀", "카데나", "칼리", "호영", "제논", "레테"],
    "HP": ["데몬어벤져"]
};
...
export const JOB_META_DATA: Record<string, { stat: string, att: string }> = {
    ...
    "린": { stat: "INT", att: "마력" }, "렌": { stat: "STR", att: "공격력" }, "레테": { stat: "INT", att: "마력" },
    // 궁수 (DEX, 공격력)
