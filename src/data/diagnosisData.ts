...
export const UNION_STAT_JOBS: Record<string, string[]> = {
    "STR": [
        ...
        "캐논슈터", "캐논블래스터", "캐논마스터",
        // 기타 STR 직업
        "소울마스터", "미하일", "블래스터", "데몬슬레이어", "아란", "카이저", "아델", "제로", "렌", "스트라이커", "은월", "제논"
    ],
    "DEX": [
        // 보우마스터 계열
        "헌터", "레인저", "보우마스터",
        ...
        "건슬링거", "발키리", "캡틴",
        // 기타 DEX 직업
        "윈드브레이커", "와일드헌터", "메르세데스", "카인", "엔젤릭버스터", "메카닉", "제논"
    ],
    "INT": [
        // 아크메이지(불,독) 계열
        ...
        "클레릭", "프리스트", "비숍",
        // 기타 INT 직업
        "플레임위자드", "배틀메이지", "에반", "루미너스", "키네시스", "일리움", "라라"
    ],
    "LUK": [
        // 나이트로드 계열
        "어쌔신", "허밋", "나이트로드",
