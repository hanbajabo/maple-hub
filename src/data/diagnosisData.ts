...
export const UNION_STAT_JOBS: Record<string, string[]> = {
    "STR": ["히어로", "팔라딘", "다크나이트", "소울마스터", "미하일", "블래스터", "데몬슬레이어", "아란", "카이저", "아델", "제로", "렌", "제논"],
    "DEX": ["보우마스터", "신궁", "패스파인더", "윈드브레이커", "와일드헌터", "메르세데스", "카인", "제논"],
    "INT": ["비숍", "플레임위자드", "아크메이지(불,독)", "배틀메이지", "에반", "루미너스", "키네시스", "일리움", "라라"],
    "LUK": ["나이트로드", "섀도어", "듀얼블레이드", "팬텀", "칼리", "호영", "제논"],
    "HP": ["데몬어벤져"]
};
...
export const JOB_META_DATA: Record<string, { stat: string, att: string }> = {
    ...
    "아크메이지(불.독)": { stat: "INT", att: "마력" }, "아크메이지(썬.콜)": { stat: "INT", att: "마력" },
    "아크메이지(불, 독)": { stat: "INT", att: "마력" }, "아크메이지(썬, 콜)": { stat: "INT", att: "마력" },
    ...
    "린": { stat: "INT", att: "마력" }, "렌": { stat: "STR", att: "공격력" },
    // 궁수 (DEX, 공격력)
