...
export const EXP_DATA = [
    ...
    { level: 210, requiredExp: 7344309856, increaseRate: 20, cumulativeExp: 57537167869 },
    { level: 211, requiredExp: 8152183940, increaseRate: 11, cumulativeExp: 65689351809 },
    { level: 212, requiredExp: 9048924173, increaseRate: 11, cumulativeExp: 74738275982 },
    { level: 213, requiredExp: 10044305832, increaseRate: 11, cumulativeExp: 84782581814 },
    { level: 214, requiredExp: 11149179473, increaseRate: 11, cumulativeExp: 95931761287 },
    { level: 215, requiredExp: 13379015367, increaseRate: 20, cumulativeExp: 109310776654 },
    { level: 216, requiredExp: 14583126750, increaseRate: 9, cumulativeExp: 123893903404 },
    { level: 217, requiredExp: 15895608157, increaseRate: 9, cumulativeExp: 139789511561 },
    { level: 218, requiredExp: 17326212891, increaseRate: 9, cumulativeExp: 157115724452 },
    { level: 219, requiredExp: 18885572051, increaseRate: 9, cumulativeExp: 176001296503 },
    { level: 220, requiredExp: 22662686461, increaseRate: 20, cumulativeExp: 198663982964 },
    { level: 221, requiredExp: 24249074513, increaseRate: 7, cumulativeExp: 222913057477 },
    { level: 222, requiredExp: 25946509728, increaseRate: 7, cumulativeExp: 248859567205 },
    { level: 223, requiredExp: 27762765408, increaseRate: 7, cumulativeExp: 276622332613 },
    { level: 224, requiredExp: 29706158986, increaseRate: 7, cumulativeExp: 306328491599 },
    { level: 225, requiredExp: 35647390783, increaseRate: 20, cumulativeExp: 341975882382 },
    { level: 226, requiredExp: 38142708137, increaseRate: 7, cumulativeExp: 380118590519 },
    { level: 227, requiredExp: 40812697706, increaseRate: 7, cumulativeExp: 420931288225 },
    { level: 228, requiredExp: 43669586545, increaseRate: 7, cumulativeExp: 464600874770 },
    { level: 229, requiredExp: 46726457603, increaseRate: 7, cumulativeExp: 511327332373 },
    { level: 230, requiredExp: 56071749123, increaseRate: 20, cumulativeExp: 567399081496 },
    { level: 231, requiredExp: 57753901596, increaseRate: 3, cumulativeExp: 625152983092 },
    { level: 232, requiredExp: 59486518643, increaseRate: 3, cumulativeExp: 684639501735 },
    { level: 233, requiredExp: 61271114202, increaseRate: 3, cumulativeExp: 745910615937 },
    { level: 234, requiredExp: 63109247628, increaseRate: 3, cumulativeExp: 809019863565 },
    { level: 235, requiredExp: 75731097153, increaseRate: 20, cumulativeExp: 884750960718 },
    { level: 236, requiredExp: 78003030067, increaseRate: 3, cumulativeExp: 962753990785 },
    { level: 237, requiredExp: 80343120969, increaseRate: 3, cumulativeExp: 1043097111754 },
    { level: 238, requiredExp: 82753414598, increaseRate: 3, cumulativeExp: 1125850526352 },
    { level: 239, requiredExp: 85236017035, increaseRate: 3, cumulativeExp: 1211086543387 },
    { level: 240, requiredExp: 102283220442, increaseRate: 20, cumulativeExp: 1313369763829 },
    { level: 241, requiredExp: 105351717055, increaseRate: 3, cumulativeExp: 1418721480884 },
    { level: 242, requiredExp: 108512268566, increaseRate: 3, cumulativeExp: 1527233749450 },
    { level: 243, requiredExp: 111767636622, increaseRate: 3, cumulativeExp: 1639001386072 },
    { level: 244, requiredExp: 115120665720, increaseRate: 3, cumulativeExp: 1754122051792 },
    { level: 245, requiredExp: 138144798864, increaseRate: 20, cumulativeExp: 1892266850656 },
    { level: 246, requiredExp: 142289142829, increaseRate: 3, cumulativeExp: 2034555993485 },
    { level: 247, requiredExp: 146557817113, increaseRate: 3, cumulativeExp: 2181113810598 },
    { level: 248, requiredExp: 150954551626, increaseRate: 3, cumulativeExp: 2332068362224 },
    { level: 249, requiredExp: 155483188174, increaseRate: 3, cumulativeExp: 2487551550398 },
    { level: 250, requiredExp: 186579825808, increaseRate: 20, cumulativeExp: 2674131376206 },
    { level: 251, requiredExp: 192177220582, increaseRate: 3, cumulativeExp: 2866308596788 },
    { level: 252, requiredExp: 197942537199, increaseRate: 3, cumulativeExp: 3064251133987 },
    { level: 253, requiredExp: 203880813314, increaseRate: 3, cumulativeExp: 3268131947301 },
    { level: 254, requiredExp: 209997237713, increaseRate: 3, cumulativeExp: 3478129185014 },
    { level: 255, requiredExp: 216297154844, increaseRate: 3, cumulativeExp: 3694426339858 },
    { level: 256, requiredExp: 222786069489, increaseRate: 3, cumulativeExp: 3917212409347 },
    { level: 257, requiredExp: 229469651573, increaseRate: 3, cumulativeExp: 4146682060920 },
    { level: 258, requiredExp: 236353741120, increaseRate: 3, cumulativeExp: 4383035802040 },
    { level: 259, requiredExp: 243444353353, increaseRate: 3, cumulativeExp: 4626480155393 },
    { level: 260, requiredExp: 1731919984062, increaseRate: 612, cumulativeExp: 6358400139455 },
...
export const getMonsterParkExp = (level: number): { exp: number; area: string } => {
...
export const GRANDIS_DAILY_QUEST = [
...
export const getGrandisDailyQuest = (level: number): { exp: number; areas: string[] } => {
...
export const ARCANE_DAILY_QUEST = [
...
export const getArcaneDailyQuest = (level: number): { exp: number; areas: string[] } => {
...
// 몬파 이벤트 스킬이 적용됨
// 일주일에 1회 플레이 가능
export const EXTREME_MONSTER_PARK_EXP = [
