                        ...
                        <table className="w-full text-left border-collapse text-xs min-w-[480px]">
                            ...
                            <tbody className="text-slate-300">
                                {[
                                    ...
                                    { lv: 'LV28전사+LV28궁수+LV21마법사', gear: '전사 5단계무기+4단계방어구2개(방어+해머) / 궁수 5단계모자+4단계풀셋(볼텍스+폭시) / 마법사 3단계풀셋(힐+공격 ➔ 사망시 부활 수동 스위칭)', clear: '2-10 (보스)', note: '대성공! 🎉 전사 5단계무기+방어스킬 / 궁수 Lv.28+5단계모자 / 마법사 Lv.21+3단 스킬 스위칭으로 8회 재도전 끝에 2-10 아르카나 정령 보스 최종 돌파 성공!', ok: true },
                                ].map((row, idx) => (
                                    <tr 
                                        key={idx} 
                                        className={
