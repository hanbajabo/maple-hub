                        ...
                        <table className="w-full text-left border-collapse text-xs min-w-[480px]">
                            ...
                            <tbody className="text-slate-300">
                                {[
                                    ...
                                    { lv: 'LV28전사+LV26궁수+LV18마법사', gear: '전사 4단계 무기+방어구2개 / 궁수 4단계 풀셋(보스 폭시) / 마법사 3단계풀셋(체인+힐 ➔ 사망시 부활 수동 스위칭)', clear: '2-9', note: '2-10 (2구역 핑크빈 보스) 실패 — 전사 Lv.28 & 섬세한 수동 스위칭 컨트롤에도 불구하고 보스전 스펙 벽 확인', ok: false },
                                ].map((row, idx) => (
                                    <tr 
                                        key={idx} 
                                        className={
