                    ...
                    <section className="mb-12">
                        ...
                        <div className="bg-slate-800/30 border border-slate-700 rounded-xl p-6 mb-6">
                                ...
                                <table className="w-full text-sm">
                                    <thead className="bg-slate-900/50 border-b border-slate-600">
                                        <tr>
                                            ...
                                            <th className="p-3 text-right text-cyan-400 font-bold">변동률</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-slate-800">
                                        {/* 가을 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🍂 가을</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 1,001만 → <span className="text-blue-400">S2</span> 820만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-18.1%</span>
                                            </td>
                                        </tr>
                                        {/* 코코 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🥥 코코</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 760만 → <span className="text-blue-400">S2</span> 520만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-31.6%</span>
                                            </td>
                                        </tr>
                                        {/* 아란 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">⚔️ 아란</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 1,500만 → <span className="text-blue-400">S2</span> 550만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-63.3%</span>
                                            </td>
                                        </tr>
                                        {/* 민트 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌿 민트</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 999만 → <span className="text-pink-400">S3</span> 570만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-42.9%</span>
                                            </td>
                                        </tr>
                                        {/* 루루 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎀 루루</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 315만 → <span className="text-pink-400">S3</span> 700만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+122.2%</span>
                                            </td>
                                        </tr>
                                        {/* 호두 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌰 호두</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 530만 → <span className="text-pink-400">S3</span> 500만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 노아 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌊 노아</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 720만 → <span className="text-pink-400">S3</span> 320만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-55.6%</span>
                                            </td>
                                        </tr>
                                        {/* 바비 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💖 바비</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 800만 → <span className="text-blue-400">S2</span> 330만 → <span className="text-cyan-400">S4</span> 560만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 유키 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">❄️ 유키</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 610만 → <span className="text-blue-400">S2</span> 338만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 레이 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">⚡ 레이</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 600만 → <span className="text-blue-400">S2</span> 260만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-56.7%</span>
                                            </td>
                                        </tr>
                                        {/* 나워 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎮 나워</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 900만 → <span className="text-blue-400">S2</span> 305만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-66.1%</span>
                                            </td>
                                        </tr>
                                        {/* 바나나 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🍌 바나나</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 766만 → <span className="text-pink-400">S3</span> 311만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-59.4%</span>
                                            </td>
                                        </tr>
                                        {/* 도쿄 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🗼 도쿄</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 560만 → <span className="text-pink-400">S3</span> 300만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-46.4%</span>
                                            </td>
                                        </tr>
                                        {/* 오즈 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🧙 오즈</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 688만 → <span className="text-pink-400">S3</span> 380만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-44.8%</span>
                                            </td>
                                        </tr>
                                        {/* 모모 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🍑 모모</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 450만 → <span className="text-pink-400">S3</span> 355만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-21.1%</span>
                                            </td>
                                        </tr>
                                        {/* 고수 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🥋 고수</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 340만 → <span className="text-pink-400">S3</span> 410만 → <span className="text-cyan-400">S4</span> 305만 → <span className="text-green-400">S5</span> 300만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-11.8%</span>
                                            </td>
                                        </tr>
                                        {/* 일리움 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌟 일리움</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 370만 → <span className="text-pink-400">S3</span> 370만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 앵두 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🍒 앵두</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 340만 → <span className="text-pink-400">S3</span> 400만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+17.6%</span>
                                            </td>
                                        </tr>
                                        {/* 히히 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">😄 히히</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 270만 → <span className="text-pink-400">S3</span> 238만 → <span className="text-cyan-400">S4</span> 590만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+118.5%</span>
                                            </td>
                                        </tr>
                                        {/* 다정 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💝 다정</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 305만 → <span className="text-pink-400">S3</span> 475만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+55.7%</span>
                                            </td>
                                        </tr>
                                        {/* 파이 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🥧 파이</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 305만 → <span className="text-pink-400">S3</span> 225만 → <span className="text-cyan-400">S4</span> 440만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+44.3%</span>
                                            </td>
                                        </tr>
                                        {/* 번개 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">⚡ 번개</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 270만 → <span className="text-pink-400">S3</span> 370만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+37.0%</span>
                                            </td>
                                        </tr>
                                        {/* 블루 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💙 블루</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 320만 → <span className="text-cyan-400">S4</span> 375만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 연우 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌸 연우</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 200만 → <span className="text-pink-400">S3</span> 345만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+72.5%</span>
                                            </td>
                                        </tr>
                                        {/* 지젤 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💫 지젤</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 200만 → <span className="text-pink-400">S3</span> 250만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+25.0%</span>
                                            </td>
                                        </tr>
                                        {/* 청하 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎤 청하</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 200만 → <span className="text-cyan-400">S4</span> 315만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+57.5%</span>
                                            </td>
                                        </tr>
                                        {/* 소원 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌠 소원</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 560만 → <span className="text-pink-400">S3</span> 376만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-32.9%</span>
                                            </td>
                                        </tr>
                                        {/* 바람 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌬️ 바람</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 573만 → <span className="text-cyan-400">S4</span> 660만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 인형 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎎 인형</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 806만 → <span className="text-cyan-400">S4</span> 620만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-23.1%</span>
                                            </td>
                                        </tr>
                                        {/* 허니 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🍯 허니</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 901만 → <span className="text-cyan-400">S4</span> 520만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-42.3%</span>
                                            </td>
                                        </tr>
                                        {/* 애기 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">👼 애기</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 750만 → <span className="text-cyan-400">S4</span> 570만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-24.0%</span>
                                            </td>
                                        </tr>
                                        {/* 시프 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🗡️ 시프</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 1,016만 → <span className="text-cyan-400">S4</span> 1,000만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 닌자 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">⚔️ 닌자</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 660만 → <span className="text-pink-400">S3</span> 600만 → <span className="text-cyan-400">S4</span> 450만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 애인 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💑 애인</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 630만 → <span className="text-blue-400">S2</span> 400만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-36.5%</span>
                                            </td>
                                        </tr>
                                        {/* 뽀뽀 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💋 뽀뽀</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 608만 → <span className="text-blue-400">S2</span> 289만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-52.5%</span>
                                            </td>
                                        </tr>
                                        {/* 판다 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🐼 판다</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-cyan-400">S4</span> 340만 → <span className="text-green-400">S5</span> 245만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-27.9%</span>
                                            </td>
                                        </tr>
                                        {/* 해피 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">😊 해피</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 800만 → <span className="text-green-400">S5</span> 680만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 라임 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🍋 라임</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 700만 → <span className="text-pink-400">S3</span> 400만 → <span className="text-green-400">S5</span> 310만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 팔라딘 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🛡️ 팔라딘</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 600만 → <span className="text-green-400">S5</span> 550만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 시크 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎯 시크</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 700만 → <span className="text-pink-400">S3</span> 500만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-28.6%</span>
                                            </td>
                                        </tr>
                                        {/* 키스 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💋 키스</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 637만 → <span className="text-pink-400">S3</span> 500만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 카이저 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">👑 카이저</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 600만 → <span className="text-pink-400">S3</span> 465만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-22.5%</span>
                                            </td>
                                        </tr>
                                        {/* 궁수 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🏹 궁수</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 1,500만 → <span className="text-pink-400">S3</span> 444만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-70.4%</span>
                                            </td>
                                        </tr>
                                        {/* 데몬 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">😈 데몬</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 435만 → <span className="text-cyan-400">S4</span> 620만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+42.5%</span>
                                            </td>
                                        </tr>
                                        {/* 소울마스터 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">✨ 소울마스터</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 500만 → <span className="text-pink-400">S3</span> 355만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-29.0%</span>
                                            </td>
                                        </tr>
                                        {/* 왕자 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🤴 왕자</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 410만 → <span className="text-cyan-400">S4</span> 670만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+63.4%</span>
                                            </td>
                                        </tr>
                                        {/* 소년 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">👦 소년</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 620만 → <span className="text-cyan-400">S4</span> 810만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+30.6%</span>
                                            </td>
                                        </tr>
                                        {/* 채원 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌟 채원</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 350만 → <span className="text-cyan-400">S4</span> 500만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+42.9%</span>
                                            </td>
                                        </tr>
                                        {/* 설리 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💫 설리</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 315만 → <span className="text-cyan-400">S4</span> 300만 → <span className="text-green-400">S5</span> 325만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 카라 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎭 카라</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 415만 → <span className="text-pink-400">S3</span> 295만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-28.9%</span>
                                            </td>
                                        </tr>
                                        {/* 보이 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">👨 보이</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 305만 → <span className="text-green-400">S5</span> 280만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-orange-400">-8.2%</span>
                                            </td>
                                        </tr>
                                        {/* 포이 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌺 포이</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 200만 → <span className="text-green-400">S5</span> 275만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+37.5%</span>
                                            </td>
                                        </tr>
                                        {/* 데이 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌅 데이</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 200만 → <span className="text-cyan-400">S4</span> 350만 → <span className="text-green-400">S5</span> 394만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+97.0%</span>
                                            </td>
                                        </tr>
                                        {/* 시간 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">⏰ 시간</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 280만 → <span className="text-green-400">S5</span> 295만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 나무 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌲 나무</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 330만 → <span className="text-cyan-400">S4</span> 350만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+6.1%</span>
                                            </td>
                                        </tr>
                                        {/* 우이 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌸 우이</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 210만 → <span className="text-cyan-400">S4</span> 350만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 누리 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌍 누리</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 569만 → <span className="text-cyan-400">S4</span> 350만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-38.5%</span>
                                            </td>
                                        </tr>
                                        {/* 시드 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌱 시드</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 240만 → <span className="text-cyan-400">S4</span> 300만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+25.0%</span>
                                            </td>
                                        ...
                                        {/* 아이린 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">👸 아이린</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 230만 → <span className="text-cyan-400">S4</span> 395만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+71.7%</span>
                                            </td>
                                        </tr>
                                        {/* 채영 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎀 채영</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 485만 → <span className="text-green-400">S5</span> 300만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-38.1%</span>
                                            </td>
                                        </tr>
                                        {/* 샤이 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">😊 샤이</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 225만 → <span className="text-green-400">S5</span> 250만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+11.1%</span>
                                            </td>
                                        </tr>
                                        {/* 레아 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💎 레아</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-cyan-400">S4</span> 400만 → <span className="text-green-400">S5</span> 210만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-47.5%</span>
                                            </td>
                                        </tr>
                                        {/* 보미 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🌼 보미</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 215만 → <span className="text-cyan-400">S4</span> 325만 → <span className="text-green-400">S5</span> 215만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-slate-400">0.0%</span>
                                            </td>
                                        ...
                                        {/* 펀치 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">👊 펀치</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 370만 → <span className="text-green-400">S5</span> 290만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-21.6%</span>
                                            </td>
                                        </tr>
                                        {/* 박보영 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">⭐ 박보영</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 240만 → <span className="text-green-400">S5</span> 226만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 애정 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💗 애정</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 200만 → <span className="text-pink-400">S3</span> 230만 → <span className="text-cyan-400">S4</span> 370만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 달콤 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🍰 달콤</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 220만 → <span className="text-cyan-400">S4</span> 320만 → <span className="text-green-400">S5</span> 250만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 미스 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">👗 미스</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-pink-400">S3</span> 250만 → <span className="text-cyan-400">S4</span> 300만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 첫눈 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">❄️ 첫눈</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 205만 → <span className="text-green-400">S5</span> 160만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-22.0%</span>
                                            </td>
                                        </tr>
                                        {/* 현석 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎤 현석</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 205만 → <span className="text-green-400">S5</span> 160만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 선녀 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🧚 선녀</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 900만 → <span className="text-cyan-400">S4</span> 325만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-63.9%</span>
                                            </td>
                                        </tr>
                                        {/* 구찌 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">👜 구찌</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 300만 → <span className="text-cyan-400">S4</span> 320만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 이미 테이블에 있는 것들: 가을, 라라, 도쿄, 호두, 여우, 캡틴, 해적, 코코, 토끼, 등은 생략 */}

                                        {/* 룰루 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎀 룰루</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 315만 → <span className="text-pink-400">S3</span> 700만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 조아 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💕 조아</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 662만 → <span className="text-pink-400">S3</span> 203만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-69.4%</span>
                                            </td>
                                        </tr>
                                        ...
                                        {/* 뿌까 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🐰 뿌까</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 200만 → <span className="text-pink-400">S3</span> 130만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-35.0%</span>
                                            </td>
                                        </tr>
                                        {/* 마하 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">⚡ 마하</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 200만 → <span className="text-cyan-400">S4</span> 295만
                                            </td>
                                            <td className="p-3 text-right">
                                        ...
                                        {/* 울프 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🐺 울프</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 200만 → <span className="text-cyan-400">S4</span> 180만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-orange-400">-10.0%</span>
                                            </td>
                                        </tr>
                                        {/* 기억 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">💭 기억</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-blue-400">S2</span> 255만 → <span className="text-cyan-400">S4</span> 123만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-red-400">-51.8%</span>
                                            </td>
                                        </tr>
                                        ...
                                        {/* 비비 */}
                                        <tr className="hover:bg-slate-700/20">
                                            <td className="p-3 text-white font-semibold">🎵 비비</td>
                                            <td className="p-3 text-center text-slate-300">
                                                <span className="text-yellow-400">S1</span> 674만 → <span className="text-cyan-400">S4</span> 810만
                                            </td>
                                            <td className="p-3 text-right">
                                                <span className="text-green-400">+20.2%</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <p className="text-slate-400 text-xs mt-4 mb-0">
                                📝 총 <strong className="text-white">83개의 닉네임</strong>이 여러 시즌에 걸쳐 등락을 보였습니다.
                                이는 닉네임 시장의 역동성과 트렌드 변화를 보여줍니다.
                            </p>
                        </div>
