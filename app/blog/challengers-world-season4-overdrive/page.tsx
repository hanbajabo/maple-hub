              ...
              <div className="overflow-x-auto rounded-xl border border-slate-800 bg-slate-950/60">
                <table className="w-full text-xs sm:text-sm text-left min-w-[560px] border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-800/50 text-slate-300">
                    ...
                    <tr className="hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-emerald-400">에메랄드</td><td className="px-3 py-2">30,000</td><td className="px-3 py-2">챌린저스 월드 시즌4 에메랄드 훈장 교환권, <span className="text-yellow-300 font-bold">200레벨 달성의 비약 20개</span>, <span className="text-green-400 font-bold">카르마 레전드리 잠재능력 부여 스크롤 100% (200제)</span>, <span className="text-yellow-300 font-bold">카르마 블랙 큐브 30개</span>, 챌린저스 월드 시즌4 에메랄드 모자</td></tr>
