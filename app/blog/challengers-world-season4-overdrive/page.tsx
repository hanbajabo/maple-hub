            ...
            <div>
              ...
              <div className="overflow-x-auto rounded-xl border border-slate-800 bg-slate-950/60">
                <table className="w-full text-xs sm:text-sm text-left min-w-[560px] border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-800/50 text-slate-300">
                    <tr className="hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-amber-700">브론즈</td><td className="px-3 py-2">5,000</td><td className="px-3 py-2">챌린저스 월드 시즌4 브론즈 훈장 교환권, 솔 에르다 조각 100개, 솔 에르다 3개, 챌린저스 휘장로이드 교환권, 챌린저스 월드 시즌4 브론즈 모자, 챌린저스 3레벨 특수 스킬 반지 선택권</td></tr>
                    <tr className="bg-slate-900/10 hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-slate-300">실버</td><td className="px-3 py-2">10,000</td><td className="px-3 py-2">챌린저스 월드 시즌4 실버 훈장 교환권, 챌린저스 4레벨 특수 스킬 반지 선택권, 솔 에르다 조각 100개, 솔 에르다 3개, 챌린저스 월드 시즌4 실버 모자</td></tr>
                    <tr className="hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-yellow-400">골드</td><td className="px-3 py-2">15,000</td><td className="px-3 py-2">챌린저스 월드 시즌4 골드 훈장 교환권, 솔 에르다 조각 100개, 솔 에르다 3개, 페어리 하트, 챌린저스 월드 시즌4 골드 모자</td></tr>
                    <tr className="bg-slate-900/10 hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-blue-200">플래티넘</td><td className="px-3 py-2">20,000</td><td className="px-3 py-2">챌린저스 월드 시즌4 플래티넘 훈장 교환권, 솔 에르다 조각 300개, 솔 에르다 5개, 챌린저스 월드 시즌4 플래티넘 모자</td></tr>
                    <tr className="hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-emerald-400">에메랄드</td><td className="px-3 py-2">30,000</td><td className="px-3 py-2">챌린저스 월드 시즌4 에메랄드 훈장 교환권, 200레벨 달성의 비약 20개, 카르마 레전드리 잠재능력 부여 스크롤 100% (200제), 카르마 블랙 큐브 30개, 챌린저스 월드 시즌4 에메랄드 모자</td></tr>
                    <tr className="bg-slate-900/10 hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-blue-300">사파이어</td><td className="px-3 py-2">40,000</td><td className="px-3 py-2">챌린저스 월드 시즌4 사파이어 훈장 교환권, 카르마 에디셔널 유니크 잠재능력 부여 스크롤 100% (200제), 카르마 레전드리 잠재능력 부여 스크롤 100% (200제), 챌린저스 월드 시즌4 사파이어 모자</td></tr>
                    <tr className="hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-cyan-200">다이아몬드</td><td className="px-3 py-2">50,000</td><td className="px-3 py-2">챌린저스 월드 시즌4 다이아몬드 훈장 교환권, 카르마 화이트 에디셔널 큐브 30개, 하트 업그레이드 모듈: 플라즈마, 챌린저스 월드 시즌4 다이아몬드 모자</td></tr>
                    <tr className="bg-slate-900/10 border-t-2 border-purple-700/50 hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-purple-300">마스터</td><td className="px-3 py-2">70,000 + 메이린(노멀)</td><td className="px-3 py-2">챌린저스 월드 시즌4 마스터 훈장 교환권, 카르마 블랙 큐브 30개, 카르마 화이트 에디셔널 큐브 30개, 메멘토 방어구 스타포스 18성 강화권 (200제) 3개, 250레벨 달성의 비약 1개, 챌린저스 월드 시즌4 마스터 모자</td></tr>
                    <tr className="hover:bg-slate-900/30 bg-purple-950/10"><td className="px-3 py-2 font-bold text-pink-300">챌린저</td><td className="px-3 py-2">90,000 + 메이린(하드)</td><td className="px-3 py-2">챌린저스 월드 시즌4 챌린저 훈장 교환권, 챌린저스 월드 시즌4 챌린저 가구 교환권, 솔 야누스 스킬 강화권 (20레벨), 챌린저스 월드 시즌4 챌린저 모자</td></tr>
                    <tr className="bg-purple-950/20 hover:bg-slate-900/30"><td className="px-3 py-2 font-bold text-amber-300">슈퍼챌린저</td><td className="px-3 py-2">랭킹 상위 (1~999/1~50)</td><td className="px-3 py-2">챌린저스 월드 시즌4 슈퍼챌린저 훈장 교환권, 챌린저스 월드 시즌4 슈퍼챌린저 가구 교환권, 솔 야누스 스킬 강화권 (20레벨), 챌린저스 월드 시즌4 슈퍼챌린저 모자</td></tr>
                  </tbody>
                </table>
              </div>
