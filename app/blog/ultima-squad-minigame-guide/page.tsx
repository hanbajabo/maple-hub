                                ...
                                <table className="w-full text-left border-collapse min-w-[340px] text-xs sm:text-sm">
                                    ...
                                    <tbody className="text-slate-300 divide-y divide-slate-800/50">
                                        {[
                                            ...
                                            { lv: 'LV 28 전사 + LV 26 궁수 + LV 18 마법사', gear: '전사 4단계 무기+방어구 2개 (공격+해머) / 궁수 4단계 풀셋 (보스 폭시 체인징) / 마법사 3단계 풀셋 (체인+힐 ➔ 사망 시 부활 수동 스위칭)', clear: '2-9', note: '2-10 (2구역 핑크빈 보스) 실패 (전사 Lv.28 & 수동 스킬 스위칭 컨트롤에도 불구하고 보스전 강력한 딜/탱킹 스펙 벽 확인)' },
                                        ].map((row, idx) => {
