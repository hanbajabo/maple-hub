                                ...
                                <table className="w-full text-left border-collapse min-w-[340px] text-xs sm:text-sm">
                                    ...
                                    <tbody className="text-slate-300 divide-y divide-slate-800/50">
                                        {[
                                            ...
                                            { lv: 'LV 28 전사 + LV 28 궁수 + LV 21 마법사', gear: '전사 5단계 무기+4단계 방어구 2개 (방어+해머) / 궁수 5단계 모자+4단계 풀셋 (볼텍스+폭시) / 마법사 3단계 풀셋 (힐링+공격 ➔ 사망 시 부활 수동 스위칭)', clear: '2-10 (보스)', note: '대성공! 🎉 (전사 5단계 무기+방어스킬, 궁수 Lv.28+5단계 모자, 마법사 Lv.21+3단 스킬 스위칭 컨트롤로 8회 반복 재도전 끝에 2-10 아르카나 정령 보스 극적 클리어!)' },
                                        ].map((row, idx) => {
