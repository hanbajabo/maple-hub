                                ...
                                <table className="w-full text-left border-collapse min-w-[340px] text-xs sm:text-sm">
                                    ...
                                    <tbody className="text-slate-300 divide-y divide-slate-800/50">
                                        {[
                                            ...
                                            { lv: 'LV 12 전사 + LV 11 궁수', gear: '전사 2단계 (공격스킬 장착) / 궁수 2단계', clear: '1-8', note: '성공' },
                                            { lv: 'LV 13 전사 + LV 11 궁수', gear: '전사 2단계 (공격스킬 장착) / 궁수 2단계', clear: '1-9', note: '극적으로 성공 (3회 수동 도전)' },
                                            { lv: 'LV 13 전사 + LV 11 궁수', gear: '전사 2단계 (공격스킬 장착) / 궁수 2단계', clear: '1-9 이하', note: '1-10 (보스-핑크빈) 실패' },
