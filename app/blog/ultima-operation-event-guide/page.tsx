  ...
  return (
    <div className="min-h-screen bg-[#080711] text-slate-100 pb-24 font-sans leading-relaxed">
      ...
      <header className="w-full max-w-7xl flex justify-between items-center px-6 py-4 sticky top-0 z-50 bg-[#080711]/90 backdrop-blur-md border-b border-slate-800/80 mx-auto">
        <Link prefetch={false} href="/blog" className="flex items-center gap-2 hover:opacity-80 transition-opacity text-indigo-400 font-semibold group">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 relative z-10">
        ...
        <div className="flex justify-center mt-12 border-t border-slate-800/60 pt-8">
          <Link prefetch={false} href="/blog" className="inline-flex items-center gap-2 px-6 py-3 bg-slate-800/40 hover:bg-slate-800 text-slate-300 hover:text-white rounded-xl border border-slate-700/50 hover:border-indigo-500/50 transition-all font-semibold shadow-lg">
