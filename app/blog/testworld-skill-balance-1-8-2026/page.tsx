        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                    ...
                    <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border-2 border-slate-700 rounded-2xl p-6">
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-slate-300 text-xs sm:text-sm">• 시전 시 바로 효과가 적용되도록 수정</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-lg mb-2">베놈 버스트</h3>
                                <p className="text-slate-300 text-xs sm:text-sm">• 타격 이펙트가 출력되는 시간 수정</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="mb-12">
                    <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 border-2 border-purple-500/50 rounded-2xl p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-purple-400">직업 검색</h2>
                        </div>
                ...
                <section id="히어로" className="mb-12" style={{ display: shouldShow('히어로') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-red-900/30 to-orange-900/30 border-2 border-red-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/히어로.png" alt="히어로" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-red-400">히어로</h2>
                        </div>
                ...
                <section id="팔라딘" className="mb-12" style={{ display: shouldShow('팔라딘') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-blue-900/30 to-white/10 border-2 border-blue-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/팔라딘.png" alt="팔라딘" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-blue-400">팔라딘</h2>
                        </div>

                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">팔라딘 엑스퍼트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">최종 데미지 <span className="text-green-400">40%</span> → <span className="text-red-400">35%</span>, 크리티컬 데미지 <span className="text-green-400">20%</span> → <span className="text-red-400">17%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">디바인 저지먼트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">신성 낙인 폭발 <span className="text-green-400">700%</span> → <span className="text-red-400">622%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">디바인 저지먼트 VI 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">신성 낙인 폭발 <span className="text-green-400">1160%</span> → <span className="text-red-400">1009%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">생츄어리 VI 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">디바인 저지먼트 VI 데미지 증가 <span className="text-green-400">410%p</span> → <span className="text-red-400">357%p</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingUp className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-400 mt-0.5 flex-shrink-0" />
                            ...
                            <p className="text-slate-300 text-xs sm:text-sm">• 마이티 묠니르: 타격 이펙트 위치 수정</p>
                        </div>
                    </div>
                </section>
                ...
                <section id="다크나이트" className="mb-12" style={{ display: shouldShow('다크나이트') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-purple-900/30 to-black/30 border-2 border-purple-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/다크나이트.png" alt="다크나이트" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-purple-400">다크나이트</h2>
                        </div>
                ...
                <section id="아크메이지(불,독)" className="mb-12" style={{ display: shouldShow('아크메이지(불,독)') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 border-2 border-orange-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/아크메이지(불,독).png" alt="아크메이지(불,독)" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400">아크메이지(불,독)</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                ...
                <section id="아크메이지(썬,콜)" className="mb-12" style={{ display: shouldShow('아크메이지(썬,콜)') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 border-2 border-blue-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/아크메이지(썬,콜).png" alt="아크메이지(썬,콜)" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-cyan-400">아크메이지(썬,콜)</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">파라볼릭 볼트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">전류 방출 <span className="text-green-400">4760%</span> → <span className="text-red-400">4712%</span>, 신속의 번개 <span className="text-green-400">2100%</span> → <span className="text-red-400">2079%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="비숍" className="mb-12" style={{ display: shouldShow('비숍') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-yellow-900/30 to-white/10 border-2 border-yellow-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/비숍.png" alt="비숍" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-yellow-400">비숍</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                ...
                <section id="보우마스터" className="mb-12" style={{ display: shouldShow('보우마스터') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 border-2 border-green-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/보우마스터.png" alt="보우마스터" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-green-400">보우마스터</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">포인트 제로 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">화살 충격 <span className="text-green-400">7910%</span> → <span className="text-red-400">7590%</span>, 일점 폭발 <span className="text-green-400">8260%</span> → <span className="text-red-400">7905%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="신궁" className="mb-12" style={{ display: shouldShow('신궁') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-slate-700/30 to-blue-900/30 border-2 border-slate-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/신궁.png" alt="신궁" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-300">신궁</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">페이탈 트리거 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">파열 <span className="text-green-400">8353%</span> → <span className="text-red-400">7953%</span>, 일격 <span className="text-green-400">8543%</span> → <span className="text-red-400">8134%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="나이트로드" className="mb-12" style={{ display: shouldShow('나이트로드') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-purple-900/30 to-indigo-900/30 border-2 border-purple-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/나이트로드.png" alt="나이트로드" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-purple-400">나이트로드</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">크루셜 어썰트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">파동 <span className="text-green-400">7429%</span> → <span className="text-red-400">7325%</span>, 폭발 <span className="text-green-400">8283%</span> → <span className="text-red-400">8167%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="섀도어" className="mb-12" style={{ display: shouldShow('섀도어') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-gray-900/30 to-slate-900/30 border-2 border-gray-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/섀도어.png" alt="섀도어" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-300">섀도어</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">어센틱 다크니스 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">참격 <span className="text-green-400">7606%</span> → <span className="text-red-400">7165%</span>, 폭발 <span className="text-green-400">8821%</span> → <span className="text-red-400">8295%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="듀얼블레이드" className="mb-12" style={{ display: shouldShow('듀얼블레이드') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-red-900/30 to-black/30 border-2 border-red-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/듀얼블레이더.png" alt="듀얼블레이드" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-red-400">듀얼블레이드</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                ...
                <section id="바이퍼" className="mb-12" style={{ display: shouldShow('바이퍼') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-yellow-900/30 to-orange-900/30 border-2 border-yellow-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/바이퍼.png" alt="바이퍼" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-yellow-400">바이퍼</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                ...
                <section id="캡틴" className="mb-12" style={{ display: shouldShow('캡틴') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 border-2 border-blue-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/캡틴.png" alt="캡틴" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-blue-400">캡틴</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">파이어크래커 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">공중사격 <span className="text-green-400">6191%</span> → <span className="text-red-400">6159%</span>, 탄폭 <span className="text-green-400">6191%</span> → <span className="text-red-400">6159%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="캐논슈터" className="mb-12" style={{ display: shouldShow('캐논슈터') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-orange-900/30 to-yellow-900/30 border-2 border-orange-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/캐논마스터.png" alt="캐논슈터" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400">캐논슈터</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">배럴 오브 몽키스 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">여폭 <span className="text-green-400">5950%</span> → <span className="text-red-400">5810%</span>, 산개 폭격 <span className="text-green-400">6230%</span> → <span className="text-red-400">6090%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="미하일" className="mb-12" style={{ display: shouldShow('미하일') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-white/20 to-blue-900/30 border-2 border-white/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/미하일.png" alt="미하일" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white">미하일</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">나이트 임모탈스 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">극광 <span className="text-green-400">6827%</span> → <span className="text-red-400">6243%</span></div>
                            </div>
                            <p className="text-slate-300 text-xs sm:text-sm">• 나이트 임모탈스: 암흑 효과 적용 오류 수정</p>
                        </div>
                    </div>
                </section>
                ...
                <section id="소울마스터" className="mb-12" style={{ display: shouldShow('소울마스터') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-red-900/30 to-orange-900/30 border-2 border-red-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/소울마스터.png" alt="소울마스터" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-red-400">소울마스터</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">토탈리티 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">합일의 풍압 <span className="text-green-400">5065%</span> → <span className="text-red-400">4942%</span>, 혼참의 맹참 <span className="text-green-400">5726%</span> → <span className="text-red-400">5440%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="플레임위자드" className="mb-12" style={{ display: shouldShow('플레임위자드') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 border-2 border-orange-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/플레임위자드.png" alt="플레임위자드" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400">플레임위자드</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                ...
                <section id="윈드브레이커" className="mb-12" style={{ display: shouldShow('윈드브레이커') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-green-900/30 to-cyan-900/30 border-2 border-green-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/윈드브레이커.png" alt="윈드브레이커" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-green-400">윈드브레이커</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">엘리멘트 템페스트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">파동 <span className="text-green-400">8177%</span> → <span className="text-red-400">8027%</span>, 화살 세례 <span className="text-green-400">8537%</span> → <span className="text-red-400">8204%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="나이트워커" className="mb-12" style={{ display: shouldShow('나이트워커') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-purple-900/30 to-black/30 border-2 border-purple-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/나이트워커.png" alt="나이트워커" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-purple-400">나이트워커</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">스티지언 커맨드 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">칠흑의 장막 <span className="text-green-400">6527%</span> → <span className="text-red-400">6380%</span>, 암흑의 지배 <span className="text-green-400">5811%</span> → <span className="text-red-400">5680%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="스트라이커" className="mb-12" style={{ display: shouldShow('스트라이커') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-cyan-900/30 to-blue-900/30 border-2 border-cyan-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/스트라이커.png" alt="스트라이커" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-cyan-400">스트라이커</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">질도섬멸 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">맹공 <span className="text-green-400">6240%</span> → <span className="text-red-400">6160%</span>, 격류 <span className="text-green-400">6618%</span> → <span className="text-red-400">6510%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="아란" className="mb-12" style={{ display: shouldShow('아란') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 border-2 border-blue-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/아란.png" alt="아란" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-blue-400">아란</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">프로스트 블러스터 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">폭풍 <span className="text-green-400">8892%</span> → <span className="text-red-400">8610%</span>, 빙결참 <span className="text-green-400">8084%</span> → <span className="text-red-400">7805%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="에반" className="mb-12" style={{ display: shouldShow('에반') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-cyan-900/30 to-blue-900/30 border-2 border-cyan-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/에반.png" alt="에반" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-cyan-400">에반</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">유니온 드라이브 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">마력 공격 <span className="text-green-400">7737%</span> → <span className="text-red-400">7621%</span>, 공명의 파동 <span className="text-green-400">8424%</span> → <span className="text-red-400">8298%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="루미너스" className="mb-12" style={{ display: shouldShow('루미너스') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-yellow-900/30 to-purple-900/30 border-2 border-yellow-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/루미너스.png" alt="루미너스" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-yellow-400">루미너스</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">메모라이즈 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">1000%</span> → <span className="text-red-400">950%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">리버레이션 오브 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">820%</span> → <span className="text-red-400">770%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">앱솔루트 킬 VI 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">695%</span> → <span className="text-red-400">675%</span></div>
                            </div>
                            <div className="bg-slate-800/50 rounded-lg p-3 border border-red-500/30 mt-3">
                                <div className="flex items-center gap-2 mb-2">
                                    <TrendingDown className="w-4 h-4 text-red-400" />
                ...
                <section id="메르세데스" className="mb-12" style={{ display: shouldShow('메르세데스') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-green-900/30 to-cyan-900/30 border-2 border-green-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/메르세데스.png" alt="메르세데스" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-green-400">메르세데스</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <p className="text-slate-300 text-xs sm:text-sm">• 유니콘 스파이크: 유니콘 스파이크 VI와 재사용 대기시간 공유 오류 수정</p>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">이그니스 로어 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">최종 데미지 <span className="text-green-400">20%</span> → <span className="text-red-400">17%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">디펜스 브레이크 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">크리티컬 데미지 <span className="text-green-400">16%</span> → <span className="text-red-400">15%</span></div>
                            </div>
                            <div className="bg-slate-800/50 rounded-lg p-3 border border-red-500/30 mt-3">
                                <div className="flex items-center gap-2 mb-2">
                                    <TrendingDown className="w-4 h-4 text-red-400" />
                ...
                <section id="팬텀" className="mb-12" style={{ display: shouldShow('팬텀') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 border-2 border-purple-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/팬텀.png" alt="팬텀" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-purple-400">팬텀</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">케인 엑스퍼트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">최종 데미지 <span className="text-green-400">32%</span> → <span className="text-red-400">31%</span></div>
                            </div>
                            <div className="bg-slate-800/50 rounded-lg p-3 border border-red-500/30 mt-3">
                                <div className="flex items-center gap-2 mb-2">
                                    <TrendingDown className="w-4 h-4 text-red-400" />
                ...
                <section id="은월" className="mb-12" style={{ display: shouldShow('은월') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 border-2 border-orange-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/은월.png" alt="은월" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400">은월</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">영월 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">영압 <span className="text-green-400">2419%</span> → <span className="text-red-400">2219%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="데몬 슬레이어" className="mb-12" style={{ display: shouldShow('데몬 슬레이어') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-purple-900/30 to-red-900/30 border-2 border-purple-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/데몬슬레이어.png" alt="데몬 슬레이어" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-purple-400">데몬 슬레이어</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">아메시스틴 인트루젼 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">10885%</span> → <span className="text-red-400">10815%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="블래스터" className="mb-12" style={{ display: shouldShow('블래스터') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-orange-900/30 to-yellow-900/30 border-2 border-orange-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/블래스터.png" alt="블래스터" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400">블래스터</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">뱅가드 임팩트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">충격 <span className="text-green-400">3150%</span> → <span className="text-red-400">3045%</span>, 에너지의 잔재 <span className="text-green-400">4410%</span> → <span className="text-red-400">4375%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="와일드헌터" className="mb-12" style={{ display: shouldShow('와일드헌터') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-green-900/30 to-teal-900/30 border-2 border-green-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/와일드헌터.png" alt="와일드헌터" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-green-400">와일드헌터</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">기어 스톰 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">강타 <span className="text-green-400">3330%</span> → <span className="text-red-400">3290%</span>, 무차별 폭격 <span className="text-green-400">7810%</span> → <span className="text-red-400">7735%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="제논" className="mb-12" style={{ display: shouldShow('제논') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-cyan-900/30 to-purple-900/30 border-2 border-cyan-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/제논.png" alt="제논" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-cyan-400">제논</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <p className="text-slate-300 text-xs sm:text-sm">• 멜트다운 익스플로젼 / VI: 홀로그램 그래피티 융합 재설치 시 동작 취소 오류 수정</p>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">네오테릭 트라이스 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">파동 <span className="text-green-400">7070%</span> → <span className="text-red-400">7000%</span>, 에너지 분출 <span className="text-green-400">4375%</span> → <span className="text-red-400">4331%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="메카닉" className="mb-12" style={{ display: shouldShow('메카닉') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-gray-900/30 to-blue-900/30 border-2 border-gray-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/메카닉.png" alt="메카닉" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-300">메카닉</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <p className="text-slate-300 text-xs sm:text-sm">• 로봇 트랜지션 : CB-P1: VI 스킬 강화 방식 변경 (활성화 시 상시 장착)</p>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">메탈아머 : 익스터미네이션 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">8435%</span> → <span className="text-red-400">8331%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="카이저" className="mb-12" style={{ display: shouldShow('카이저') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-red-900/30 to-orange-900/30 border-2 border-red-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/카이저.png" alt="카이저" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-red-400">카이저</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">파이로 인스팅트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">10640%</span> → <span className="text-red-400">10325%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="카데나" className="mb-12" style={{ display: shouldShow('카데나') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 border-2 border-purple-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/카데나.png" alt="카데나" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-purple-400">카데나</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">프로페셔널 에이전트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">255%</span> → <span className="text-red-400">220%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingUp className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-400 mt-0.5 flex-shrink-0" />
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">프로페셔널 에이전트 VI 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">425%</span> → <span className="text-red-400">360%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">브루탈 래비지 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">비격 <span className="text-green-400">11900%</span> → <span className="text-red-400">11620%</span>, 분쇄 <span className="text-green-400">12460%</span> → <span className="text-red-400">11830%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="엔젤릭버스터" className="mb-12" style={{ display: shouldShow('엔젤릭버스터') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-pink-900/30 to-purple-900/30 border-2 border-pink-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/엔젤릭버스터.png" alt="엔젤릭버스터" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-pink-400">엔젤릭버스터</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">제뉴인 앙코르 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">파동 <span className="text-green-400">7491%</span> → <span className="text-red-400">7313%</span>, 매력 발산 <span className="text-green-400">7341%</span> → <span className="text-red-400">7167%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="제로" className="mb-12" style={{ display: shouldShow('제로') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 border-2 border-blue-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/제로.png" alt="제로" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-blue-400">제로</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                ...
                <section id="키네시스" className="mb-12" style={{ display: shouldShow('키네시스') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-purple-900/30 to-indigo-900/30 border-2 border-purple-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/키네시스.png" alt="키네시스" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-purple-400">키네시스</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <p className="text-slate-300 text-xs sm:text-sm">• 얼티메이트:갬빗 / VI: 공격 발생 오류 수정</p>
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">프렉탈 호라이즌 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">1554%</span> → <span className="text-red-400">1540%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="아델" className="mb-12" style={{ display: shouldShow('아델') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 border-2 border-blue-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/아델.png" alt="아델" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-blue-400">아델</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">아인하이트 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">참격 <span className="text-green-400">8120%</span> → <span className="text-red-400">7910%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="일리움" className="mb-12" style={{ display: shouldShow('일리움') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-cyan-900/30 to-blue-900/30 border-2 border-cyan-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/일리움.png" alt="일리움" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-cyan-400">일리움</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            ...
                            <p className="text-slate-300 text-xs sm:text-sm">• 크래프트:자벨린 II: 글로리 윙 20레벨 이상 습득 시 사용 가능, 매직 미사일 데미지 표시 수정</p>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">그람홀더 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">1320%</span> → <span className="text-red-400">1220%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">크래프트:자벨린 VI 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">580%</span> → <span className="text-red-400">551%</span>, 파편 <span className="text-green-400">200%</span> → <span className="text-red-400">190%</span></div>
                            </div>
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">크리스탈 스킬:데우스 VI 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">데미지 <span className="text-green-400">2050%</span> → <span className="text-red-400">1890%</span>, 위성 <span className="text-green-400">545%</span> → <span className="text-red-400">500%</span></div>
                            </div>
                            <p className="text-slate-300 text-xs sm:text-sm">• 크래프트:롱기누스 VI: 맵 이동 시 연결 끊김 수정</p>
                        </div>
                    </div>
                </section>
                ...
                <section id="칼리" className="mb-12" style={{ display: shouldShow('칼리') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-indigo-900/30 to-purple-900/30 border-2 border-indigo-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/칼리.png" alt="칼리" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-indigo-400">칼리</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">보이드 어웨이크 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">질주 <span className="text-green-400">5915%</span> → <span className="text-red-400">5800%</span>, 초월 차크리 <span className="text-green-400">6310%</span> → <span className="text-red-400">6185%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="아크" className="mb-12" style={{ display: shouldShow('아크') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-yellow-900/30 to-purple-900/30 border-2 border-yellow-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/아크.png" alt="아크" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-yellow-400">아크</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                ...
                <section id="라라" className="mb-12" style={{ display: shouldShow('라라') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-green-900/30 to-cyan-900/30 border-2 border-green-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/라라.png" alt="라라" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-green-400">라라</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                ...
                <section id="렌" className="mb-12" style={{ display: shouldShow('렌') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-red-900/30 to-black/30 border-2 border-red-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/렌.png" alt="렌" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-red-400">렌</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <p className="text-slate-300 text-xs sm:text-sm">• 망혼검 절기 : 무량겁 / VI: 타격 이펙트 출력 시간 수정</p>
                            <div className="bg-slate-800/50 rounded-lg p-3 border border-red-500/30 mt-3">
                                <div className="flex items-center gap-2 mb-2">
                                    <TrendingDown className="w-4 h-4 text-red-400" />
                ...
                <section id="호영" className="mb-12" style={{ display: shouldShow('호영') ? 'block' : 'none' }}>
                    <div className="bg-gradient-to-br from-yellow-900/30 to-red-900/30 border-2 border-yellow-500/50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-4 sm:mb-6">
                            <Image src="/images/jobs/호영.png" alt="호영" width={48} height={48} className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg" />
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-yellow-400">호영</h2>
                        </div>
                        <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-slate-200">
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                            ...
                            <div className="leading-relaxed">
                                <div className="flex items-start gap-1.5 mb-1">
                                    <TrendingDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400 mt-0.5 flex-shrink-0" />
                                    <span className="font-semibold">천세휘령 🔽</span>
                                </div>
                                <div className="pl-5 sm:pl-5.5">기운 <span className="text-green-400">4504%</span> → <span className="text-red-400">4410%</span>, 휘령 <span className="text-green-400">4322%</span> → <span className="text-red-400">4270%</span></div>
                            </div>
                        </div>
                    </div>
                </section>
