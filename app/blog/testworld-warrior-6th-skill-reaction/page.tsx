...
const jobReactions = [
    ...
    },
    {
        ...
        summary: <>
            신규 스킬의 화려한 연출은 호평이지만, <strong>데몬 어웨이크닝(어웨)의 스택 압축 필요성</strong>을 두고 유저 간 의견 대립이 팽팽합니다. 극딜 압축을 바라는 목소리도 높으나, 어웨의 타격감과 날개 연출 등 직업의 낭만을 위해 <strong>임팩트를 전면 삭제하고 어웨를 상시화</strong>해 달라는 의견 또한 강력히 제시되고 있습니다. 결국 근본적인 해법은 직업 자체 체급을 올리거나, 어웨이크닝을 메인 스킬로 사용할 수 있게끔 하는 패치가 있으면 좋을 것 같다는 의견이 있습니다.
