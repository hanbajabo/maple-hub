...
const jobReactions = [
    ...
    },
    {
        ...
        dilRate: '',
        keyIssue: "신스킬 '만참'의 15초 쿨타임 제한으로 인한 평딜 효율 저하 및 승화 분리 극딜 사이클 꼬임 현상",
        posts: [
