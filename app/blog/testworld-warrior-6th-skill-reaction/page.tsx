...
const jobReactions = [
    ...
    },
    {
        ...
        summary: <>
            신규 스킬의 화려한 연출은 호평이지만, <strong>데몬 어웨이크닝(어웨)의 스택 압축 필요성</strong>을 두고 유저 간 의견 대립이 팽팽합니다. 극딜 압축을 바라는 목소리도 높으나, 어웨의 타격감과 날개 연출 등 직업의 낭만을 위해 <strong>임팩트를 전면 삭제하고 어웨를 상시화</strong>해 달라는 의견 또한 강력히 제시되고 있습니다. 결국 근본적인 해법은 극딜 압축 강박보다는 <strong>직업 자체의 순수 체급을 높여주는 것</strong>이라는 분석이 유저들의 공감대를 얻고 있습니다.
            <div className="mt-4 pt-3 border-t border-violet-800/40">
                <a 
                    href="https://www.inven.co.kr/board/maple/5974/6850518" 
                    target="_blank" 
                    rel="noopener noreferrer"
                ...
                >
                    <MessageSquare className="w-3.5 h-3.5" />
                    <span>추옵추적자님의 데슬 이펙트 변화 글 바로가기</span>
                </a>
            </div>
        </>,
    },
    ...
    },
    {
        ...
        dilRate: '',
        keyIssue: '마제스티 오브 카이저와의 극딜 구조 충돌 및 극딜 구조 변경으로 인한 윌오소 봉인',
        posts: [
        ...
        summary: <>카이저 극딜의 핵심은 마제스티 오브 카이저(마오카) 버프 지속 시간 동안 주력 스킬인 윌 오브 소드와 인퍼널 브레스의 재사용 대기시간 초기화를 최대한 빈번하게 발동시키는 것입니다. 그러나 <strong>3.5초 동안 키다운을 하는 신규 6차</strong>를 리레 극딜 주기 내에 사용하게 되면, 그여축 사출 작업 및 오리진 연계 시간까지 겹쳐 <strong>윌 오브 소드 사용이 제한되는 치명적인 구조 충돌</strong>이 발생합니다. 이로 인해 <strong>신스킬 레벨이 19레벨 이하일 때는 극딜 중에 신스킬을 시전하는 것이 오히려 전체 누적 딜량 손실</strong>이라는 분석이 나왔습니다. <strong>그여축 확률 개선의 실질 딜 기여도 또한 1% 미만으로 미미</strong>하다는 분석도 나오면서 불만이 가중되는 상황입니다. 키다운 스킬의 데미지가 극딜의 역할을 잘 할 수 있게 상향하던가, 차라리 설치기나 즉발형으로 바뀌는 등 다양한 개선 사항이 올라오고 있습니다.
            <div className="mt-4 pt-3 border-t border-purple-800/40">
                <a
                    href="https://www.inven.co.kr/board/maple/2294/456206"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 text-xs text-purple-300 hover:text-purple-200 underline font-semibold transition-colors"
                >
                    <MessageSquare className="w-3.5 h-3.5" />
                    <span>카이저이상함님의 분석글 바로가기</span>
                </a>
            </div>
        </>,
    },
    ...
    },
    {
        ...
        skill: '창룡파천검 : 만참',
        sentiment: 'critical',
        sentimentLabel: '극심한 불만 (쿨타임 구조 오류)',
        ...
        dilRate: '',
        keyIssue: "신스킬 '만참'의 15초 쿨타임 제한으로 인한 불만 및 승화 분리 강제성 논란",
        posts: [
            '걍 심검 발동 시마다 자동 발동하게 하면 되잖아 쿨 15초를 왜 달아',
            '렌분들 걍 신스킬 노쿨로 받아야합니다. 명색이 6차 신스킬입니다.',
            '●▅▇█▇▆▅▄▇ 만참 쿨타임 삭제 반드시 필요함',
            '승화 분리 안 하다가 신스킬 들어오면서 분리해야 할지 고민임',
            '신스킬 쿨타임 때문에 2초뚝이나 5초뚝 등 쿨감뚝 세팅 효율에 대한 의문이 큼',
        ],
        summary: <>원래 렌은 쉬운 조작과 높은 자유도가 장점인 직업이었으나, 신규 6차 스킬 <strong>'만참'에 15초의 쿨타임</strong>이 부여되면서 유저들의 분노가 극에 달했습니다. 유저들은 <strong>심검 발동 시마다 쿨타임 없이 만참이 자동으로 발동(자동 사출)</strong>되도록 개선해 줄 것을 강력히 요구하고 있습니다. 더불어 신규 스킬의 쿨타임으로 인해 <strong>불편한 '승화 분리' 극딜 사이클을 꼭 해야 한다는 의견</strong>과 2초뚝/5초뚝 등 <strong>쿨감 모자(쿨뚝) 세팅의 효율성 논란</strong>이 함께 화두로 떠오르고 있습니다.</>,
    },
];
