...
const jobReactions = [
    ...
    },
    {
        ...
        summary: <>둥그런 원판이 돌아가는 <strong>"굴렁쇠" 연출</strong>에 대해 10년 가까이 애정으로 캐릭을 키운 올드 유저들마저 <strong>"게임을 접고 싶다", "신스킬이 너무 못생겨서 손대기 싫다"</strong>며 이펙트의 관련된 부정적 의견이 많습니다. 그 외에 신규 스킬 자체 데미지 보다는 <strong>데미지 10% + 포스 회복 효과를 통한 유틸적인 부분을 보완하는 스킬로 봐야 한다는 평가</strong>가 많습니다.</>,
    },
    {
        job: '렌',
        skill: '창룡파천검 : 만참',
