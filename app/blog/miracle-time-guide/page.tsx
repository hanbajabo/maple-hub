          ...
          <div className="mt-6 bg-amber-950/40 border border-amber-600/40 rounded-xl p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                { name: '에테르넬 방어구', desc: '현 최종 방어구. 장기 사용을 전제로 꾸준히 직접 천천히 스타포스와 잠재능력을 직작해서 쓸 유저들에게 추천', tag: '추천', tagColor: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/30' },
