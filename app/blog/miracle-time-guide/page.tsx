          ...
          <div className="mt-6 bg-amber-950/40 border border-amber-600/40 rounded-xl p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                { name: '칠흑 장신구', desc: '고레벨 핵심 장신구. 장기 사용 전제라면 레전드리 투자 가치 있음', tag: '조건부', tagColor: 'bg-yellow-500/20 text-yellow-300 border-yellow-500/30', warn: '⚠️ 노작 칠흑을 등급업해서 쓸 분들은 장교불(장비 착용시 교환 불가) 상태에서 돌리세요! 타 직업 주스텟이 뜨면 장교불 상태에서 바로 파는 것이 좋습니다.' },
