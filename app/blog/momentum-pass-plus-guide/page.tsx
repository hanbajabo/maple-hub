...
export default function MomentumPassPlusGuidePage() {
    ...
    const FINAL_TABLE_DATA = [
        ...
        //   크림슨 입장권 5개 × (4,051 / 4,790 / 5,651) + VIP사우나 3개 × 205
        //   e280: (5000 + 5×4051 + 3×205) / 2.98 = 25,870 / 2.98 ≈ 8,681
        //   e285: (5000 + 5×4790 + 3×205) / 2.98 = 29,565 / 2.98 ≈ 9,919
        //   e290: (5000 + 5×5651 + 3×205) / 2.98 = 33,870 / 2.98 ≈ 11,364
        { 
            name: "모멘텀 패스 PLUS", 
