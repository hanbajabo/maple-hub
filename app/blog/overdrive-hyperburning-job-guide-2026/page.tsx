...
const youtubers = [
    ...
    },
    {
        ...
        dot: 'bg-green-400',
        jobs: [
            { name: '보우마스터', image: '/images/jobs/보우마스터.png', score: '✅ 메인 추천', tag: '뉴비 국밥픽', reason: '난이도 메이플 최하 수준, 무빙 속사기 딜 누수 없음, 장인·초보 딜 차이 가장 적음', con: '극딜 시간 너무 길어 최상위권 보스에서 한계, 무적기 부재, 보조무기 가격 비쌈' },
...
const top10 = [
    ...
    },
    {
        ...
        cons: ['극딜 시간 너무 길어 최상위권 보스에서 한계', '쓸만한 무적기 부재', '보조무기 가격 비쌈'],
