...
async function run() {
    ...
    if (!ocidRes.ocid) {
        console.error('Character "쯔단" not found!');
        return;
    }
    ...
    // Save full JSON
    fs.writeFileSync('scratch/zzudan_nexon_full.json', JSON.stringify({ basic: basicRes, stat: statRes, hexa: hexaRes }, null, 2), 'utf8');
}
